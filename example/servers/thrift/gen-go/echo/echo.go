...
func (p *EchoClient) Echo(ctx context.Context, req *EchoReq) (r *EchoRes, err error) {
	if err = p.sendEcho(ctx, req); err != nil {
		return
	}
	return p.recvEcho(ctx)
}

func (p *EchoClient) sendEcho(ctx context.Context, req *EchoReq) (err error) {
...
func (p *EchoClient) recvEcho(ctx context.Context) (value *EchoRes, err error) {
